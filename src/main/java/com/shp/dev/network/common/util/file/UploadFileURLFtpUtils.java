 ...
 */
public class UploadFileURLFtpUtils {
     ...
     * @param port
     */
    public UploadFileURLFtpUtils(String userName, String password, String host, int port) {
     ...
     * @return: java.lang.String
     */
    public String currencySaveFile(String filePath, String fileName, String last) {
        //最终文件的目录
     ...
     */
    public String currencySaveFile(String filePath, String fileName) {
        //最终文件的目录
        String path = new SimpleDateFormat("yyyy/MM/dd").format(new Date());
        return saveFile(filePath, path, fileName);
    }

    public String saveFile(String imgUrl, String directory, String fileName) {
        try {
            URL url = new URL(imgUrl);
            URLConnection con = url.openConnection();
            InputStream is = con.getInputStream();
            UploadFileURLFtpUtils sftp = new UploadFileURLFtpUtils(userName, password, host, port);
            sftp.login();
            // 多级目录创建并上传
    ...
    public static void main(String[] args) {
        UploadFileURLFtpUtils sftp = new UploadFileURLFtpUtils("root", "sS123456", "47.92.213.36", 22);
        String s = sftp.currencySaveFile("https://ieye.hsttw.cn/snapshot/out/2020/09/01/13112207071320100010/1311220707132010001001598936339001.jpg", "1shp.jpg", "111");
