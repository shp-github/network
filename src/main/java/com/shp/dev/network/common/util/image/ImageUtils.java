...
//             Integer MOVE = number.divide(olDnumber).intValue()*150;
    ...
    public static void main(String[] args) {
        ...
        try {
            //裁剪矩形
            //image.cut_JPG(inputFilePath, outFilePath, 400,300,900,750);

            //image.cut_Image(inputFilePath, outFilePath,"jpg", 400,300,900,750);

            //image.cut_Image2(inputFilePath, outFilePath, 400,300,900,750);

            //裁剪多边形
            /*int x[]={860,650,300,1700};
            int y[]={20,20,1000,1000};
            image.cutPolygon_Image(inputFilePath, outFilePath,x,y,4);*/


            int x[]={860,650,300,1700};
            int y[]={20,20,1000,1000};
            int n=4;
            cutPolygon_Image("D:\\cut.jpg","D:\\cut.jpg",x,y,n);


            //绘图多边形
            /*int x[]={860,650,400,300,1700};
            int y[]={20,20,500,1000,1000};
            image.drawingPolygon_Image(inputFilePath, outFilePath, x, y, 5);*/

            //绘图矩形
            //image.drawingRectangular_Image(inputFilePath, outFilePath, 400, 300, 900,750);
            ...
            image.drawingText_Image(inputFilePath, outFilePath, listMap);*/

            //添加图片水印
            //image.imageWatermarking_Image(iconPath, inputFilePath, outFilePath, -45);
