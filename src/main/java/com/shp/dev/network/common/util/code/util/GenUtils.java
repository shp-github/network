package com.shp.dev.network.common.util.code.util;
...
import com.shp.dev.network.common.util.code.model.ColumnEntity;
import com.shp.dev.network.common.util.code.model.MongoGeneratorEntity;
import com.shp.dev.network.common.util.code.model.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.shp.dev.network" : mainPath;
        //封装模板数据
        ...
        map.put("datetime", DateUtils.getCustomizeDateTime("yyyy-MM-dd HH:mm:ss"));
    ...
    public static Configuration getConfig() {
        try {
            return new PropertiesConfiguration("genreator.properties");
