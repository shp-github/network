...
public class Redis {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Socket socket = new Socket(Constant.REDIS_HOST, Constant.REDIS_PORT);
        Redis redis = new Redis(socket);

        //存读字符串
        //redis.call("SET", "name", "aaa");
        //byte [] bytes = redis.call("GET", "name");
        //String str=new String(bytes);
        //System.out.println(str);

        //存储字集合
        //redis.call("LPUSH", "mylist", "A", "B", "C", "D");
        //List<byte []> list = redis.call("LRANGE", "mylist", "0", "200");
        //for (byte[] bytes : list) {
        //    String str=new String(bytes);
        //    System.out.println(str);
        //}
        ...
        //多一个A redis中A的数值会加1
        //List<Object> wirte = redis.pipeline()
        //        .call("MULTI")
        //        .call("INCR", "count")
        //        .call("INCR", "count")
        //        .call("EXEC")
