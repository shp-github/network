 ...
 * @CreateBy: shp
 * @Version: 1.0
 * @Description: TODO WebSocketServer 处理类
 * @CreateTime: 2020/9/2 21:52
...
public class WebSocketServer {
    ...
    public void onOpen(Session session) {
        ...
        System.out.print("有连接加入，当前连接数为：{}" + cnt);
    ...
    public void onClose(Session session) {
        ...
        System.out.print("有连接关闭，当前连接数为：{}" + cnt);
    }
    ...
    public void onMessage(String message, Session session) {
        System.out.print("来自客户端的消息：{}" + message);
