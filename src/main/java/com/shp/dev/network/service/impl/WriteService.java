...
import com.shp.dev.network.mapper.WriteMapper;
import com.shp.dev.network.mapper.WriteMapperPlus;
...
public class WriteService implements IWriteService {
    ...
    @Override
    public ResultBean insert(SysWrite model) {
        return ResultBean.success(plus.insert(model));
    }
